...
using static Example04.Tests.Helpers.AuthenticationHeaderBuilder;
using static Example04.Presentation.Authentication.BasicConstants;

namespace Example04.Tests.IntegrationTests;
